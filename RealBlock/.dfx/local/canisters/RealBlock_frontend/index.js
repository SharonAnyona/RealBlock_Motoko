...
import { idlFactory } from './RealBlock_frontend.did.js';
export { idlFactory } from './RealBlock_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.REALBLOCK_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./RealBlock_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the RealBlock_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./RealBlock_frontend.did.js")._SERVICE>}
 */
