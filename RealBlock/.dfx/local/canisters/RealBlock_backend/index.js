...
import { idlFactory } from './RealBlock_backend.did.js';
export { idlFactory } from './RealBlock_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.REALBLOCK_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./RealBlock_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the RealBlock_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./RealBlock_backend.did.js")._SERVICE>}
 */
export const RealBlock_backend = createActor(canisterId);
